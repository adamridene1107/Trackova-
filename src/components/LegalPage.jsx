...
function CGU() {
  return (
    <>
      ...
      <Section n="8" title="Données utilisateur"><p>Vos tâches, objectifs et données de progression vous appartiennent. Vous pouvez les exporter ou les supprimer à tout moment.</p></Section>
